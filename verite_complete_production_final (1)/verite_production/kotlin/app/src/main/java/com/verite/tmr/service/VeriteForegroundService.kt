package com.verite.tmr.service
...
import com.verite.tmr.MainActivity
import com.verite.tmr.R
...
class VeriteForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.verite.tmr.action.START_SESSION"
        const val ACTION_STOP  = "com.verite.tmr.action.STOP_SESSION"
